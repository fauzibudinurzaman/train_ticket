				...
				<!-- Banner -->
					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								<li class="icon solid fa-phone">085524867552</li>
								<li class="icon solid fa-envelope"><a href="#">diva@mail.com</a></li>
							...
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li> By: Diva Anggraeni</li>
							</ul>
						</div>
					</section>
